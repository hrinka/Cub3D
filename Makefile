...
#    Updated: 2024/06/17 23:57:15 by hirosuzu         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LIBFT_SRC = libft/ft_isdigit.c libft/ft_strlen.c libft/ft_strncmp.c libft/ft_strchr.c libft/ft_calloc.c libft/ft_realloc.c libft/ft_bzero.c libft/ft_strnstr.c libft/ft_atoi.c libft/ft_strdup.c libft/ft_split.c libft/ft_memset.c libft/ft_isspace.c \
...
ABD_SRC = srcs/move_mouse.c srcs/move_player.c srcs/cub3d.c srcs/my_raycasting.c srcs/my_init.c srcs/my_print.c srcs/my_draw.c
